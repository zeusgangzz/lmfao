...
module.exports.run = async(client, message, args) => {
    ...
    try {
        ...
        message.channel.send(new client.embed().setDescription('Please provide me an equation.').setFooter(`${message.guild.name} | Made by the devs`, message.guild.iconURL({ dynamic: true })))
    }
}