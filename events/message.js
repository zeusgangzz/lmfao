...
module.exports = (client, message) => {
        ...
        const responses = ['who made this bot', 'whos woosh', 'whos jake', 'who made the bot']
        if (responses.includes(message.content))
            message.reply(`The creator of this amazing bot is The Astral Networks Dev Team`)
    ...
    if (command && !client.conf.economy.enabled && command.category === 'economy') return message.channel.send(new client.embed().setDescription('The economy has not been enabled!'))
