...
module.exports = async client => {
        ...
        console.log(`\x1b[34m` + "[Thank You] Thanks for using the bot")
        console.log(`\x1b[35m` + "[Creator] Made By The Devs")
        console.log(`\x1b[34m` + "[Support] If you require support do jack shit")
